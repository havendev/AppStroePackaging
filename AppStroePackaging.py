...
project_name = ''    # 项目名称
archive_workspace_path = '/Users/haven/Documents/xxx'    # 项目路径
...
altool_path = "/Applications/Xcode.app/Contents/Applications/Application\ Loader.app/Contents/Frameworks/ITunesSoftwareService.framework/Versions/A/Support/altool "#altool的路径
user_id = "xxxx"#AppleID
pass_word = "xxxxx"#AppleID的密码
noError = 0
...
class AutoArchive(object):
    ...
    def upload_appstore(self):
        dirName = archive_workspace_path + '/' + export_directory
